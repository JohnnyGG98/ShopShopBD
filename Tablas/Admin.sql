...
CREATE TABLE admin."HistorialRutasAdmin"(
...
CREATE TABLE admin."ClientesBloqueados"(
...
CREATE TABLE admin."VendedoresBloqueados"(
...
CREATE TABLE admin."ComentariosBloqueados"(
...
CREATE TABLE admin."HistorialProductosVisitas"(
...
CREATE TABLE admin."HistorialRutasVisitas"(
